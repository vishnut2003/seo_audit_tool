...
export interface OrganicRevenueMonthlyReportInterface {
...
export async function fetchOrganicRevenueMonthlyReport({
    analyticsClient,
    dateFilters,
    propertyId,
}: {
    ...
    return new Promise<OrganicRevenueMonthlyReportInterface>(async (resolve, reject) => {
        try {
            const dimensions: {
                name: string,
            }[] = [
            ...
            const finalResponse: OrganicRevenueMonthlyReportInterface = {
