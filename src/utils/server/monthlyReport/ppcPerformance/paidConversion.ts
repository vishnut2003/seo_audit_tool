...
export interface PaidConversionMonthlyReportInterface {
...
export async function fetchPaidConversionDataMonthlyReport({
    analyticsClient,
    dateFilters,
    propertyId,
}: {
    ...
    return new Promise<PaidConversionMonthlyReportInterface>(async (resolve, reject) => {
        try {
            const dimensions: {
                name: string,
            }[] = [
            ...
            const finalResponse: PaidConversionMonthlyReportInterface = {
