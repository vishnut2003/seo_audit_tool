...
export interface PaidConversionRateMonthlyReportInterface {
...
export async function fetchPaidConversionRateMonthlyReport({
    analyticsClient,
    dateFilters,
    propertyId,
}: {
    ...
    return new Promise<PaidConversionRateMonthlyReportInterface>(async (resolve, reject) => {
        try {
            const dimensions: {
                name: string,
            }[] = [
            ...
            const finalResponse: PaidConversionRateMonthlyReportInterface = {
