...
export async function GSC_getGeminiGenerativModel() {
        ...
        try {
            ...
            const model = genAi.getGenerativeModel({
                ...
                systemInstruction: {
                    parts: [
                        {
                            text: "User will ask question from the stringify json data from Google search console. create response accordingly.",
                        },
                        {
                            text: "Google search console data is in the conversation."
                        }
                    ],
                    role: 'system',
                }
