...
const LoginSection = () => {
    ...
    return (
        <div className="w-dvw h-dvh bg-white flex justify-center items-center p-4">
            <div className="max-w-[400px] w-full h-max bg-white shadow-xl shadow-gray-200 rounded-xl px-7 py-9 flex flex-col gap-3">
                ...
                <p className="text-sm mt-3 text-left">{currentForm === "login" && "Forget password?"}
                    ...
                    className="text-themeprimary font-semibold cursor-pointer ml-1">{currentForm === "login" ? "Reset" : "Login"}</span>
                </p>
            </div>
        </div>
    )
